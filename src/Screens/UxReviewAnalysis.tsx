      ...
      <div className="min-h-[650px] pb-10 bg-customsoftware flex flex-col">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-y-5 lg:gap-y-0 px-[1vw] lg:h-[700px] xl:h-[300px] w-[98vw] md:w-[80vw] lg:w-[85vw] mx-auto mt-10 overflow-x-auto">
          {FlipCard(
            ...
            "DVT provide software development consultants to augment client development capacity, off-shore and near-shore skills augmentation, and co-sourced teams"
          )}
          {FlipCard(
            "",
            "#1F456E",
            "Project based custom software development solutions",
            "Outsourced software development, application porting, and enterprise application integration."
          )}
          {FlipCard(
            "",
            "rgb(70,130,180)",
            "Consulting services",
            "Providing full or partial system audits, software architecture assessments, and custom software development technology consulting."
          )}
          {FlipCard(
            "",
            "#33363D",
            "Code Reviews",
            "We analyse, identify and resolve issues in your code base helping to ensure scalability, reliability and compliance with coding best practices."
          )}
          {FlipCard(
            "",
            "#666362",
            "Technical Analysis",
            "To define the application and required technical implementation architecture to meet your business requirements."
          )}
        </div>
